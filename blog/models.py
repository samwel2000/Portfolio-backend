...
class Project(models.Model):
    ...
    project_setting = models.CharField(
        max_length=300, default="featured project")
    heading = models.CharField(max_length=200)
    content = models.TextField()
    project_stack = models.TextField(
        help_text="Enter stack separated by a cooma")
...
class Skill(models.Model):
    heading = models.CharField(max_length=1000)
    skill_liist = models.TextField(
        help_text="Enter skills separated by a comma")
...
class Resume(models.Model):
    file = models.FileField(
        upload_to='resume', max_length=300, storage=RawMediaCloudinaryStorage())
